# nf-core/scrnaseq: Configuration for other clusters
...
Nextflow has [excellent integration](https://www.nextflow.io/docs/latest/docker.html) with Docker, and beyond installing the two tools, not much else is required - nextflow will automatically fetch the [nfcore/scrnaseq](https://hub.docker.com/r/nfcore/scrnaseq/) image that we have created and is hosted at dockerhub at run time.
...
process.container = "nf-core/scrnaseq"
```
...
```nextflow
singularity.enabled = true
process.container = "/path/to/nf-core-scrnaseq.simg"
```
