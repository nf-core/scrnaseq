...
if __name__ == "__main__":
    ...
    ### Optional arguments
    parser.add_argument("-v", "--version", dest="version", default=3, help="Version for features file, defines expected file name (1=kallisto,<v3 cellranger,3=star,>=v3 cellranger).")
    parser.add_argument("-d", "--umi_frac_median", dest="umi_frac_median", default=0.01, help="Minimum UMI Fraction of median.")
    ...
    parser.add_argument("-a", "--aligner", dest="aligner", default='cellranger', help="Aligner used: cellranger,alevin,star,kallisto")
